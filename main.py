...
from app.presentation.api import auth_routes, user_routes, event_routes, reservation_routes, user_medical_information_routes, location_routes, user_role_routes, role_permission_routes, role_routes, permission_routes
